...
// Added one valid and one invalid test cases for GWinitState
test suite for GWinitState {
    ...
    example invalidGWinitState is not GWinitState[GWState] for {
    GWState = `S0
    Goat = `G0 + `G1 + `G2
    Wolf = `W0 + `W1 + `W2
    GWAnimal = Goat + Wolf
...
// Added one valid and one invalid test cases for GWfinalState
test suite for GWfinalState {
    ...
    example invalidGWfinalState is not GWfinalState[GWState] for {
    GWState = `S0
    Goat = `G0 + `G1 + `G2
    Wolf = `W0 + `W1 + `W2
    GWAnimal = Goat + Wolf
...
test suite for GWTransitionStates {
    
    example invalidGWTransitionStates is not GWTransitionStates for {
    GWState = `S0 + `S1 + `S2
    Goat = `G0 + `G1 + `G2
    Wolf = `W0 + `W1 + `W2
    GWAnimal = Goat + Wolf
