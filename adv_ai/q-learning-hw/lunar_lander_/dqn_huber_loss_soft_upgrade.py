...
class DQNAgent:
    def __init__(self, state_dim, action_dim, lr=0.001, gamma=0.99, tau=0.005, epsilon=1.0, epsilon_decay=0.995, epsilon_min=0.01, buffer_size=10000, batch_size=64):
...
plt.title("DQN-Huber Loss with Soft Target Network Update")
plt.xlabel("Episode")
plt.ylabel("Average Reward")
plt.plot(reward_moving_average, label='DQN Moving Average Reward')
plt.legend()
plt.tight_layout()
plt.savefig("dqn_huber_hard_upgrade.png")
