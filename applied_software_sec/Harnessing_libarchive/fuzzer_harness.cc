...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *buf, size_t len) {
    ...
    while (true) {
        ...
        // Accessing various properties of the archive entry
        // These calls are primarily for exercising the libarchive API
        // and are not strictly necessary for a minimal fuzzing harness.
    ...
    // Additional API calls to further exercise libarchive
